Feature: Product Detail Page tests
	...
	# 	Then the product value is visible Então o valor do produto fica visível

	# Scenario: Validate product image
	# 	Then The product image should be displayed Então a imagem do produto deve ser exibida